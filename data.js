export const bio = [
  "Hello! I'm Roee Ovadia, and I’ve been building and leading web development projects. With over 20 years of experience in web development, I specialize in creating robust, user-friendly web solutions. My expertise spans both frontend and backend technologies, with a focus on delivering successful projects for businesses and startups.   My focus is on delivering SAAS platforms, mobile apps, websites, eCommerce platforms, and marketing solutions that work seamlessly across browsers. I’ve worked with both frontend and backend technologies like React and Angular, nodejs, ASP.NET, PHP, and more. I’m passionate about helping businesses grow through web solutions, and I’ve had the chance to lead tech teams at places like Verifone and Cypago. Now, I run go-sites interactive, where I help companies succeed online ",
  "sdf"
];
